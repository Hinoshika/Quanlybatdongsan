...
export default function AddThuaDatModal({ open, onClose, onSubmit }) {
    ...
    >
      <Form form={form} layout="vertical" onFinish={handleFinish}>
            ...
            <Form.Item label="Loại đất" name="loai_dat">
              <Select
                options={[
                  ...
                  {
                    value: "Đất xây dựng trụ sở cơ quan",
                    label: "Đất xây dựng trụ sở cơ quan.",
                  },
                  {
                    value: "Đất quốc phòng, an ninh",
                    label: "Đất quốc phòng, an ninh.",
                  },
                  {
                    value: "Đất xây dựng công trình sự nghiệp",
                    label: "Đất xây dựng công trình sự nghiệp",
                  },
                  {
                    value: "Đất sử dụng cho mục đích công cộng",
                    label: "Đất sử dụng cho mục đích công cộng",
                  },
                  {
                    value: "Đất sản xuất, kinh doanh phi nông nghiệp",
                    label: "Đất sản xuất, kinh doanh phi nông nghiệp",
                  },
        ...
        <Row gutter={16}>
          ...
          <Col span={8}>
            <Form.Item name="tinh" label="Tỉnh" rules={[{ required: true }]}>
              <Select
                options={[
          ...
          <Row gutter={16}>
            <Col span={8}>
              <Input
                placeholder="Họ tên"
                value={owner.ho_ten}
                onChange={(e) => updateOwner("ho_ten", e.target.value)}
              />
            </Col>
            ...
            <Col span={8}>
              <Input
                placeholder="CCCD"
                value={owner.so_cccd}
                onChange={(e) => updateOwner("so_cccd", e.target.value)}
              />
            </Col>
            ...
            <Col span={8}>
              <Input
                ...
                value={owner.so_dien_thoai}
                onChange={(e) => updateOwner("so_dien_thoai", e.target.value)}
              />
            </Col>
          </Row>
          ...
          >
            <Col span={16}>
              <Input
                placeholder="Địa chỉ"
                value={owner.dia_chi}
                onChange={(e) => updateOwner("dia_chi", e.target.value)}
              />
            </Col>
            ...
            <Col span={8}>
              <InputNumber
                ...
                max={100}
                addonAfter="%"
                value={owner.ty_le_so_huu}
                onChange={(v) => updateOwner("ty_le_so_huu", v)}
              />
            </Col>
          </Row>
        </div>
        ...
        >
          ...
          {coordinates.map((point, index) => (
            ...
            >
              ...
              <Col span={4}>
                <Button danger onClick={() => removePoint(index)}>
                  Xóa
                </Button>
              </Col>
            </Row>
          ...
          <Button type="dashed" onClick={addPoint}>
            + Thêm điểm
          </Button>
        </div>
