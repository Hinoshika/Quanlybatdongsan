    ...
    >
      ...
      <Form form={form} layout="vertical" onFinish={handleFinish}>
        ...
        >
          ...
          <Form.Item name="muc_dich_su_dung" label="Mục đích sử dụng">
            <Input />
          </Form.Item>

          <Form.Item name="hinh_thuc_su_dung" label="Hình thức sử dụng">
            <Input />
          </Form.Item>

          <Form.Item name="thoi_han_su_dung" label="Thời hạn sử dụng">
            <Input />
          </Form.Item>

          <Form.Item name="nguon_goc_su_dung" label="Nguồn gốc sử dụng">
            <Input />
          </Form.Item>
        ...
        <Tabs
          ...
          items={[
            ...
            },
            {
              key: "3",
              label: "🗺 Bản đồ",
              children: <ThuaDatMap selected={selected} />,
            },
          ]}
        />
      )}
