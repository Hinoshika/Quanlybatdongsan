        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Form.Item name="lat" hidden rules={[{ required: true, message: "Chọn vị trí bản đồ" }]}>
                        <Input />
                    </Form.Item>

                    <Form.Item name="lng" hidden rules={[{ required: true, message: "Chọn vị trí bản đồ" }]}>
                        <Input />
                    </Form.Item>
                </div>
                            ...
                            { title: "CCCD", dataIndex: "so_cccd" },
                            {
                                ...
                                render: (_, record, index) => (
                                    <InputNumber
                                        ...
                                        onChange={(value) =>
                                            handleChangePercent(index, value)
                                        }
                                    />
                                )
                            },
                ...
                {/* ================= MAP ================= */}
                <div style={{ height: 400, marginTop: 20, borderRadius: 8, overflow: "hidden" }}>
                    {geom ? (
