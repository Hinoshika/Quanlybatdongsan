...
const DetailModal = ({ open, selected, setOpen }) => {
  return (
    <Modal
      ...
      width={1200}
      title={
        selected?.isConstruction ? "Thông tin Công Trình" : "Thông tin Thửa Đất"
      }
    >
      {selected && (
        <Row gutter={[24, 24]}>
          <Col xs={24} lg={14}>
            ...
            >
              {selected.isConstruction ? (
                <>
                  <Descriptions.Item label="Tên công trình">
                    {selected.ten_cong_trinh}
                  </Descriptions.Item>
                  <Descriptions.Item label="Loại công trình">
                    {selected.loai_cong_trinh}
                  </Descriptions.Item>
                  ...
                  <Descriptions.Item label="Diện tích xây dựng">
                    {selected.dien_tich_xay_dung} m²
                  </Descriptions.Item>
                  <Descriptions.Item label="Năm xây dựng">
                    {selected.nam_xay_dung}
                  </Descriptions.Item>
                  <Descriptions.Item label="Kết cấu">
                    {selected.ket_cau}
                  </Descriptions.Item>
                  <Descriptions.Item label="Hình thức sở hữu">
                    {selected.hinh_thuc_so_huu}
                  </Descriptions.Item>
